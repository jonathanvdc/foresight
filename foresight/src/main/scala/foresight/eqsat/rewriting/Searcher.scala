...
object Searcher {
   ...
   */
  def empty[NodeT, MatchT, EGraphT <: ReadOnlyEGraph[NodeT]]: Searcher[NodeT, MatchT, EGraphT] = {
   ...
   */
  implicit class SearcherOfPatternMatchPairsOps[NodeT, EGraphT <: ReadOnlyEGraph[NodeT]](val self: Searcher[NodeT, (PatternMatch[NodeT], PatternMatch[NodeT]), EGraphT]) extends AnyVal {
