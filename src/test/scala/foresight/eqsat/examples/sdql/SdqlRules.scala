...
object SdqlRules {
  ...
  val multAssoc1: SdqlRule = {
    val a = MixedTree.Call(Pattern.Var.fresh[SdqlIR]())
    val b = MixedTree.Call(Pattern.Var.fresh[SdqlIR]())
    val c = MixedTree.Call(Pattern.Var.fresh[SdqlIR]())
    Rule(
      "mult-assoc1",
  ...
  val subIdentity: SdqlRule = {
    val e = MixedTree.Call(Pattern.Var.fresh[SdqlIR]())
    Rule(
      "sub-identity",
      Sub(e, e).toSearcher,
      Num(0)().toApplier
  ...
  val letBinop3: SdqlRule = {
    val e1 = MixedTree.Call(Pattern.Var.fresh[SdqlIR]())
    val e2 = MixedTree.Call(Pattern.Var.fresh[SdqlIR]())
    val e3 = MixedTree.Call(Pattern.Var.fresh[SdqlIR]())
    val x = Slot.fresh()
    val f = MixedTree.Call(Pattern.Var.fresh[SdqlIR]())
    Rule(
      "let-binop3",
  ...
  val multToIf: SdqlRule = {
    val e1_1 = MixedTree.Call(Pattern.Var.fresh[SdqlIR]())
    val e1_2 = MixedTree.Call(Pattern.Var.fresh[SdqlIR]())
    val e2 = MixedTree.Call(Pattern.Var.fresh[SdqlIR]())
    Rule(
      "mult-to-if",
  ...
  val beta: SdqlRule = {
    val t = MixedTree.Call(Pattern.Var.fresh[SdqlIR]())
    val body = MixedTree.Call(Pattern.Var.fresh[SdqlIR]())
    val x = Slot.fresh()
    Rule(
      "beta",
      ...
      body
        ...
        .substitute(body.call, x, t.call, body.call)
    )
  }

  val sumFact1: SdqlRule = {
    val r = MixedTree.Call(Pattern.Var.fresh[SdqlIR]())
    val x = Slot.fresh()
    val y = Slot.fresh()
    val e1 = MixedTree.Call(Pattern.Var.fresh[SdqlIR]())
    val e2 = MixedTree.Call(Pattern.Var.fresh[SdqlIR]())
    Rule(
      ...
      Sum(x, y, r, Mult(e1, e2))
        .toSearcher
        .filter((subst, _) => {
          val slotSet = subst(e1.call).slotSet
  ...
  val sumFact2: SdqlRule = {
    ...
    Rule(
      ...
      Sum(x, y, r, Mult(e1, e2))
        .toSearcher
        .filter((subst, _) => {
          val slotSet = subst(e2.call).slotSet
          !slotSet.contains(subst(x)) && !slotSet.contains(subst(y))
        }),
  ...
  val sumSumVertFuse1: SdqlRule = {
    ...
    val k2 = Slot.fresh()
    val v2 = Slot.fresh()
    val body1 = MixedTree.Call(Pattern.Var.fresh[SdqlIR]())
    val body2 = MixedTree.Call(Pattern.Var.fresh[SdqlIR]())
    Rule(
      "sum-sum-vert-fuse-1",
  ...
  val sumSumVertFuse2: SdqlRule = {
    ...
    val k2 = Slot.fresh()
    val v2 = Slot.fresh()
    val key = MixedTree.Call(Pattern.Var.fresh[SdqlIR]())
    val body1 = MixedTree.Call(Pattern.Var.fresh[SdqlIR]())
    val body2 = MixedTree.Call(Pattern.Var.fresh[SdqlIR]())
    Rule(
      "sum-sum-vert-fuse-2",
  ...
  val sumRange1: SdqlRule = {
    val st = MixedTree.Call(Pattern.Var.fresh[SdqlIR]())
    val en = MixedTree.Call(Pattern.Var.fresh[SdqlIR]())
    val k = Slot.fresh()
    val v = Slot.fresh()
    val key = MixedTree.Call(Pattern.Var.fresh[SdqlIR]())
    val body = MixedTree.Call(Pattern.Var.fresh[SdqlIR]())
  ...
  val sumMerge: SdqlRule = {
    val r = MixedTree.Call(Pattern.Var.fresh[SdqlIR]())
    val s = MixedTree.Call(Pattern.Var.fresh[SdqlIR]())
    val k1 = Slot.fresh()
    val v1 = Slot.fresh()
    val k2 = Slot.fresh()
    val v2 = Slot.fresh()
  ...
  val getToSum: SdqlRule = {
    val dict = MixedTree.Call(Pattern.Var.fresh[SdqlIR]())
    val key = MixedTree.Call(Pattern.Var.fresh[SdqlIR]())
    val k = Slot.fresh()
    val v = Slot.fresh()
    Rule(
  ...
  val sumToGet: SdqlRule = {
    ...
    Rule(
      ...
      Sum(k, v, dict, IfThen(Equality(Var(k), key), body))
        .toSearcher
        .filter((subst, _) => {
          val keySlots = subst(key.call).slotSet
  ...
  val getRange: SdqlRule = {
    val st = MixedTree.Call(Pattern.Var.fresh[SdqlIR]())
    val en = MixedTree.Call(Pattern.Var.fresh[SdqlIR]())
    val idx = MixedTree.Call(Pattern.Var.fresh[SdqlIR]())
    Rule(
      "get-range",
