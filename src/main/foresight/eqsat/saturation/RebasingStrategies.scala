...
object RebasingStrategies {
   ...
   * @param limitCycle A function that takes a strategy and returns a new strategy with an iteration limit. This is used
   *                   to limit the number of iterations for each cycle.
  ...
  def sympy[NodeT, EGraphT <: EGraphLike[NodeT, EGraphT] with EGraph[NodeT]](rules: Seq[Rule[NodeT, _, EGraphT]],
                                                                             ...
                                                                             cycles: Int = 2,
                                                                             limitCycle: Strategy[EGraphWithRoot[NodeT, EGraphT], _] => Strategy[EGraphWithRoot[NodeT, EGraphT], _] = _.withIterationLimit(30),
