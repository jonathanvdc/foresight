...
/**
 * A prioritizer that assigns a uniform priority to all matches.
 *
 ...
 */
final case class UniformPrioritizer[NodeT, RuleT <: Rule[NodeT, MatchT, _], MatchT](maxBatchSize: Int)
    extends MatchPrioritizer[NodeT, RuleT, MatchT] {
